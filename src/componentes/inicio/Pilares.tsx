            ...
            <svg ref={torreRef} viewBox="0 0 1000 1080" role="group" aria-label={t.ariaPiramide}>
              <defs>
                ...
                <pattern id={`${id}-agricultura`} patternUnits="userSpaceOnUse" width="1000" height="1080">
                  <image href="/imagens/hero/pilar-saneamento.jpg" x="0" y="500" width="1000" height="360" preserveAspectRatio="xMidYMid slice" />
                </pattern>
                <pattern id={`${id}-animais`} patternUnits="userSpaceOnUse" width="1000" height="1080">
                  <rect x="0" y="330" width="1000" height="300" fill="#dcebed" />
                  <image href="/imagens/vitrine/gado-nova.png" x="190" y="330" width="220" height="300" preserveAspectRatio="xMidYMid slice" />
                  <image href="/imagens/vitrine/aves-nova.png" x="390" y="330" width="220" height="300" preserveAspectRatio="xMidYMid slice" />
                  <image href="/imagens/vitrine/suinos-nova.png" x="590" y="330" width="220" height="300" preserveAspectRatio="xMidYMid slice" />
                </pattern>
                <pattern id={`${id}-ciencia`} patternUnits="userSpaceOnUse" width="1000" height="1080">
                  <image href="/imagens/hero/microscopio.jpg" x="300" y="170" width="400" height="240" preserveAspectRatio="xMidYMid slice" />
                </pattern>
