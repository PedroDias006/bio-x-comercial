...
const temas: Record<string, Tema> = {
  "agricultura-unica": {
    ...
    texto: "text-[#0f3f22]",
    olho: "text-[#2e7d32]",
    foto: "/imagens/vitrine/agricultura-bombona-campo.jpg",
  ...
  saneamento: {
    ...
    texto: "text-[#153e3a]",
    olho: "text-[#326b5e]",
    foto: "/imagens/vitrine/saneamento-vertical.jpg",
    posicao: "center",
    fotoInteira: true,
  },
  "saude-do-gado": {
    ...
    texto: "text-[#173849]",
    olho: "text-[#3e6278]",
    foto: "/imagens/vitrine/gado-vertical.jpg",
    posicao: "center",
    fotoInteira: true,
  },
  "saude-unica-suinos": {
    ...
    texto: "text-[#183e4b]",
    olho: "text-[#406a77]",
    foto: "/imagens/vitrine/suinos-vertical.jpg",
    posicao: "center",
    fotoInteira: true,
  },
  "saude-unica-aves": {
    ...
    texto: "text-[#29422e]",
    olho: "text-[#526d3e]",
    foto: "/imagens/vitrine/aves-vertical.jpg",
    fotoInteira: true,
  },
};
