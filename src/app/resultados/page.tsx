...
import {
  depoimentos,
  eventos,
  podePublicarDepoimentos,
} from "@/dados/depoimentos";

// Como usamos "use client", metadata precisa ir para o layout ou page root separada
// se este for o arquivo page.tsx. Se este for apenas o componente da página,
// você importa isso na page.tsx e exporta os metadados de lá.
    ...
    <main className="bg-[#fbfcfc] selection:bg-[#00aabe] selection:text-white">
      ...
      <section className="relative flex min-h-[90vh] items-center justify-center pt-24 pb-20">
        <Image
          ...
          alt="Lavoura demonstrando resultados BIO-X"
          fill
          priority
        ...
        <Conteiner className="relative z-10 w-full text-center">
          <div className="mx-auto flex flex-col items-center">
            ...
            <h1 className="max-w-[900px] text-[clamp(3.5rem,7vw,6.5rem)] font-medium leading-[1] tracking-[-0.04em] text-white">
              O campo não mente. <br />
              <span className="text-[#5ed7df]">Ele mostra.</span>
            </h1>

            <p className="mt-8 max-w-[650px] text-lg font-medium leading-relaxed text-white/80 md:text-xl">
              Deixamos o laboratório e fomos para onde a tecnologia é realmente posta à prova: na sua realidade, lado a lado, safra após safra.
            </p>
          </div>
        </Conteiner>
        ...
        >
          <span className="text-[10px] font-bold uppercase tracking-widest">Veja os resultados</span>
        ...
        <Conteiner>
          <div className="mb-14 text-center">
            <h2 className="text-3xl font-medium tracking-tight text-[#07313d] md:text-5xl">
              A diferença só importa <br className="hidden md:block" />
              <span className="text-[#00aabe]">se for vista lado a lado.</span>
            </h2>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              {
                id: "01",
                titulo: "Mesmo ambiente",
                texto: "A comparação parte de condições equivalentes: mesma propriedade, solo e safra.",
                img: "/imagens/placeholder-lado-1.jpg"
              },
              {
                id: "02",
                titulo: "Aplicação real",
                texto: "Tecnologia observada dentro do manejo e da rotina operacional que você já faz.",
                img: "/imagens/placeholder-lado-2.jpg"
              },
              {
                id: "03",
                titulo: "Raiz e Produtividade",
                texto: "O resultado que salta aos olhos quando a planta é arrancada da terra.",
                img: "/imagens/placeholder-lado-3.jpg"
              },
            ].map((item) => (
          ...
          <div className="mb-16 md:flex md:items-end md:justify-between">
            <div className="max-w-2xl">
              ...
              <h2 className="text-4xl font-medium tracking-tight text-[#07313d] md:text-5xl">
                O que nossas lentes <br /> <span className="text-[#00aabe]">capturaram.</span>
              </h2>
            </div>
            <p className="mt-6 max-w-sm text-base text-[#5f7880] md:mt-0 md:text-right">
              Dias de campo, parcelas comparativas e a transformação real documentada em imagens.
            </p>
          </div>
                  ...
                  <div className={`grid md:grid-cols-[1.2fr_1fr] lg:grid-cols-[1.5fr_1fr] ${invertido ? "md:[&>*:first-child]:order-2" : ""}`}>
                    ...
                    <div className="flex flex-col justify-center p-8 lg:p-14">
                      ...
                      <div className="mt-auto border-t border-[#dce9eb] pt-6 flex items-center gap-4">
                        ...
                        <div>
                          <p className="text-sm font-bold text-[#07313d]">Transformação Visível</p>
                          <p className="text-xs font-medium text-[#7a9096]">Tecnologia aplicada na lavoura</p>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <Conteiner>
          <div className="mb-12 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div className="max-w-3xl">
              <h2 className="text-4xl font-medium tracking-tight text-[#07313d] md:text-5xl">
                Quem vive do campo, <br />
                <span className="text-[#00aabe]">assina embaixo.</span>
              </h2>
            </div>
          ...
          <div className="mx-auto max-w-5xl">
            <div className="mb-10 text-center">
              <p className="mb-4 inline-block rounded-full bg-[#eaf7f8] px-4 py-2 text-[10px] font-bold uppercase tracking-[0.2em] text-[#00aabe]">
                Assista ao Caso de Sucesso
              </p>
              <h2 className="text-3xl font-medium tracking-tight text-[#07313d] md:text-5xl">
                A biotecnologia em <span className="text-[#00aabe]">ação.</span>
              </h2>
            </div>
